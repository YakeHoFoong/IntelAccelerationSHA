/* SPDX-FileCopyrightText: 2018 Written and placed in public domain by Jeffrey Walton
...
extern "C" {
#endif
	extern void sha256_process(uint32_t state[8], const uint8_t data[], uint32_t length);
#ifdef __cplusplus
}
#endif
